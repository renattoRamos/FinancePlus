...
const DEBT_CATEGORIES: DebtCategory[] = ["Moradia", "Cartão de Crédito", "Empréstimos", "Boletos", "Outros"];

interface DebtListControlsProps {
  searchTerm: string;
