...
import { SubscriptionCategory, SubscriptionStatus } from "@/types/subscription";
...
export const SubscriptionListControls = ({
  searchTerm,
  onSearchChange,
  filterCategory,
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="flex gap-2">
          <Select value={sortKey} onValueChange={onSortKeyChange}>
            ...
            <SelectContent>
              <SelectItem value="nextBillingDate">Próxima Cobrança</SelectItem>
